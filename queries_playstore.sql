...
--11.Find the most out of date app. Hint: You don’t need to do it this way, but it’s possible to 
...
SELECT * FROM analytics ORDER BY price desc LIMT 1;
...
--have been installed at least 100,000 times. Display the name of the app along with the number of 
--reviews, the min_installs, and the proportion.

SELECT app_name, reviews, min_installs, min_installs / reviews AS install_to_review_ratio FROM analytics
WHERE min_installs >= 100000 ORDER BY install_to_review_ratio desc LIMIT 1;